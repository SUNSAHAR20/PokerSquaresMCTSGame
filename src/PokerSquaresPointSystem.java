...
public class PokerSquaresPointSystem {
	...
	/**
	 * Create a point system given an array of hand scores. The score at index n
	 * corresponds to the score for hand classification number n. These will be
	 * truncated to be between the minimum and maximum allowable hand scores.
	 * 
	...
	/**
	 * Return an array of scores indexed by Poker hand classification identification
	 * numbers.
	 * 
	 * @return an array of scores indexed by Poker hand classification
	...
	/**
	 * Get an int array with the individual hand scores of rows 0 through 4 followed
	 * by columns 0 through 4.
	 * 
	...
	/**
	 * Return a random point system with scores uniformly distributed across the
	 * range of all allowable values.
	 * 
	 * @return a random point system with scores uniformly distributed across the
	 *         range of all allowable values
	 */
	...
	/**
	 * Return a random hypercorner point system where hand scores are either -1 or 1
	 * with equal probability.
	 * 
	 * @return a random hypercorner point system where hand scores are either -1 or
	...
	/**
	 * Return a point system where only the one Poker hand (given by Poker hand
	 * classification identification number) scores 1 point. All other hands score
	 * nothing.
	 * 
	 * @param pokerHandId Poker hand classification identification number
	 * @return a point system where only the one Poker hand (given by Poker hand
	 *         classification identification number) scores 1 point
	 */
	...
	/**
	 * Return a point system where only one randomly selected Poker hand scores 1
	 * point. All other hands score nothing.
	 * 
	 * @return a point system where only one randomly selected Poker hand scores 1
	 *         point
	 */
	...
	/**
	 * Return the British point system. Also known as the British or U.K. point
	 * system.
	 * 
	...
	/**
	 * Return an "Ameritish" point system randomly generated between the normalized
	 * point ranges established by the American and British systems.
	 * 
	 * @return an "Ameritish" point system randomly generated between the normalized
	 *         point ranges established by the American and British systems
	 */
